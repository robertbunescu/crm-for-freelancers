...
>(({ className, ...props }, ref) => (
  <tfoot
    ref={ref}
    className={cn(
      'border-t border-border-subtle bg-surface-2/50 font-medium [&>tr]:last:border-b-0',
      className
    )}
    {...props}
  />
...
>(({ className, ...props }, ref) => (
  <tr
    ref={ref}
    className={cn(
      'group relative border-b border-border-subtle',
...
>(({ className, ...props }, ref) => (
  <td
    ref={ref}
    className={cn(
      'px-4 py-3 align-middle text-[13px] text-text-primary',
      '[&:has([role=checkbox])]:pr-0',
      className
    )}
    {...props}
